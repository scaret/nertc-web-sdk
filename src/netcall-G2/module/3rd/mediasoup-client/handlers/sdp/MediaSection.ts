...
export class OfferMediaSection extends MediaSection {
    ...
    switch (kind) {
      ...
      case 'video': {
        ...
        for (const codec of offerRtpParameters!.codecs) {
          const rtp: any = {
            //@ts-ignore https://g.hz.netease.com/yunxin/nertc-web-sdk/-/commit/3780ebb10d86e1b7d02aae49c6ee3e1cbf53acf9#d6522015c750a5761a0ed63df42780b64c5033d4_300_299
        ...
        this._mediaObject.payloads = offerRtpParameters!.codecs
          //@ts-ignore https://g.hz.netease.com/yunxin/nertc-web-sdk/-/commit/3780ebb10d86e1b7d02aae49c6ee3e1cbf53acf9#d6522015c750a5761a0ed63df42780b64c5033d4_327_329
          .map((codec: RtpCodecParameters) => codec.payloadType || codec.localPayloadType || 125)
          .join(' ')
  ...
  planBStopReceiving({ offerRtpParameters }: { offerRtpParameters: RtpParameters }): void {
    const encoding = offerRtpParameters.encodings![0]
    const ssrc = encoding.ssrc
    const rtxSsrc = encoding.rtx && encoding.rtx.ssrc ? encoding.rtx.ssrc : undefined
