function getPlatformInfo () {
   ...
   */
  function cleanupOS (os:string, pattern: RegExp, label: string) {
   ...
   */
  function each (object:any, callback:(item:any, index:number|string, object?:any)=>any) {
    var index = -1,
   ...
   */
  function forOwn (object:any, callback:(item:any, index:number|string, object:any)=>{}) {
   ...
   */
  function isHostType (object:any, property:string|number) {
   ...
   */
  function qualify (string:string) {
   ...
   */
  function reduce (array: any[], callback:(accumulator: any, value: any, index: string|number, array?: any[])=>{}) {
  ...
  function parse (ua:string) {
    ...
    /** Opera `[[Class]]`. */
    var operaClass:any = reOpera.test(
      (operaClass =
     ...
     */
    function getLayout (guesses: any[]) {
     ...
     */
    function getManufacturer (guesses: any) {
     ...
     */
    function getProduct (guesses: any[]) {
      return reduce(guesses, function (result, guess) {
        var pattern = guess.pattern || qualify(guess)
        if (
          !result &&
     ...
     */
    function getVersion (patterns: string[]) {
