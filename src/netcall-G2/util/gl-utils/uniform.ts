...
function genUniformSetter(
    ...
    if (type === gl.FLOAT) {
        return isArray
            ? (value: Iterable<number> | Float32List) =>
                  gl.uniform1fv(location, value)
            : (value: number) => gl.uniform1f(location, value);
    }
    const floatVecMap = {
        [gl.FLOAT_VEC2]: (value: Iterable<number> | Float32List) =>
            gl.uniform2fv(location, value),
        [gl.FLOAT_VEC3]: (value: Iterable<number> | Float32List) =>
            gl.uniform3fv(location, value),
        [gl.FLOAT_VEC4]: (value: Iterable<number> | Float32List) =>
    ...
    if (type === gl.INT || type === gl.BOOL) {
        return isArray
            ? (value: Iterable<number> | Int32List) =>
    ...
    const intVecMap = {
        [gl.INT_VEC2]: (value: Iterable<number> | Int32List) =>
            gl.uniform2iv(location, value),
        [gl.INT_VEC3]: (value: Iterable<number> | Int32List) =>
            gl.uniform3iv(location, value),
        [gl.INT_VEC4]: (value: Iterable<number> | Int32List) =>
    ...
    const floatMatMap = {
        [gl.FLOAT_MAT2]: (value: Iterable<number> | Float32List) =>
            gl.uniformMatrix2fv(location, false, value),
        [gl.FLOAT_MAT3]: (value: Iterable<number> | Float32List) =>
            gl.uniformMatrix3fv(location, false, value),
        [gl.FLOAT_MAT4]: (value: Iterable<number> | Float32List) =>
...
export function parseUniforms(
    ...
    const uniforms: {
        [key: string]: {
            ...
            setter: (value?: UniformValueType) => void;
        };
    } = {};
