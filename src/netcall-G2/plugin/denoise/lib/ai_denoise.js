...
function missingLibraryFunc(sym) {
  return () =>
    abort(
      'Call to `' +
        sym +
        '` which is a library function and not included by default; add it to your library.js __deps or to DEFAULT_LIBRARY_FUNCS_TO_INCLUDE on the command line'
    )
}
...
var wasmBinaryFile
wasmBinaryFile = 'ai_denosie.wasm.wasm'
...
/** @type {function(...*):?} */
var _rnnoise_Malloc = (Module['_rnnoise_Malloc'] = createExportWrapper('rnnoise_Malloc'))

/** @type {function(...*):?} */
var _rnnoise_Free = (Module['_rnnoise_Free'] = createExportWrapper('rnnoise_Free'))
...
var _rnnoise_process_frame = (Module['_rnnoise_process_frame'] =
  createExportWrapper('rnnoise_process_frame'))
...
var registerDeviceOrientationEventCallback = missingLibraryFunc(
...
var registerOrientationChangeEventCallback = missingLibraryFunc(
  'registerOrientationChangeEventCallback'
)
var fillFullscreenChangeEventData = missingLibraryFunc('fillFullscreenChangeEventData')
var registerFullscreenChangeEventCallback = missingLibraryFunc(
...
var softFullscreenResizeWebGLRenderTarget = missingLibraryFunc(
...
var registerPointerlockChangeEventCallback = missingLibraryFunc(
  'registerPointerlockChangeEventCallback'
)
var registerPointerlockErrorEventCallback = missingLibraryFunc(
...
var registerVisibilityChangeEventCallback = missingLibraryFunc(
...
var webglPrepareUniformLocationsBeforeFirstUse = missingLibraryFunc(
