//Common Configs
const SDK_VERSION = '4.6.25' // WEBPACK_STRING_REPLACE_VERSION -don't delete the comment
const ENGINE_VERSION = '4.6.25.0'
...
import { Config, ENV, LBS_BUILD_CONFIG } from './config.production' // WEBPACK_STRING_REPLACE_ENV -don't delete the comment
