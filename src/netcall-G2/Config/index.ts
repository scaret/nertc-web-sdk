//Common Configs
const SDK_VERSION = "4.3.0";// WEBPACK_STRING_REPLACE_VERSION -don't delete the comment
const ENGINE_VERSION = "4.3.0.0";
...
import {Config} from "./config.production";// WEBPACK_STRING_REPLACE_ENV -don't delete the comment
